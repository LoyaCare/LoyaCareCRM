...
import { useGetLeadsQuery } from "@/features/lead/model/api";
      ...
      <TableRow>
        ...
        {headCells.map((headCell) => (
          <TableCell
            ...
            {...headCell.minWidth ? { style: { minWidth: headCell.minWidth } } : {}}
            {...headCell.maxWidth ? { style: { maxWidth: headCell.maxWidth } } : {}}  
          >
            <TableSortLabel
