...
type DealFormProps = {
  initialData?: DealExt;
  dealId?: string;
  onSubmit?: (form: CreateDealDTO | UpdateDealDTO, shouldCreate?: boolean) => void;
};
...
export const DealUpsertForm: React.FC<DealFormProps> = ({
  ...
  const isNew = !dealId && !initialData;
  ...
  const [form, setForm] = useState<CreateDealDTO | UpdateDealDTO>(
    initialData as CreateDealDTO | UpdateDealDTO
  );
